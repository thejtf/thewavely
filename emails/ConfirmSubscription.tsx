...
const ConfirmSubscriptionEmail = ({ link = 'link.com/confirm?fake-token' }) => {
  const previewText = `确认订阅 浪潮外刊TheWavely 的动态吗？`

  return (
    <Layout previewText={previewText}>
      <Section className="mt-[24px]">
        <Img
          src={`https://cdn.jsdelivr.net/gh/thejtf/AssetsRepo/subscription-email-header.jpg`}
          width="250"
          height="129.28"
          alt="Cali"
